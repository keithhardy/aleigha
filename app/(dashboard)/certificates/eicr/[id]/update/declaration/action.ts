...
export async function updateDeclaration(electricalInstallationConditionReport: z.infer<typeof UpdateDeclarationSchema>): Promise<ServerActionResponse<void>> {
  try {
