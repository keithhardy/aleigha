                  ...
                  <FormItem>
                    ...
                    <Popover open={inspectorOpen} onOpenChange={setInspectorOpen}>
                      <PopoverTrigger asChild className="w-full">
                        <Button variant="outline" role="combobox" aria-expanded={inspectorOpen ? "true" : "false"} className="flex justify-between items-center lg:max-w-[50%]">
                              ...
                              {users.map((user) => (
                                <CommandItem
                                  ...
                                  onSelect={(currentValue) => {
                                    form.setValue("inspectorId", currentValue, { shouldDirty: true });
                            ...
                            <CommandGroup>
                              {users.map((user) => (
                                <CommandItem
                                  ...
                                  value={user.id}
                                  onSelect={(currentValue) => {
                                    form.setValue("reviewerId", currentValue, { shouldDirty: true });
                                    form.setValue("reviewDate", new Date(), { shouldDirty: true });
                                    setInspectorOpen(false);
                                  }}
                                >
                                  {user.name}
