...
export default async function UpdateDistributionEquipment({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <UpdateDistributionEquipmentForm electricalInstallationConditionReport={electricalInstallationConditionReport as ElectricalInstallationConditionReport} />;
}
