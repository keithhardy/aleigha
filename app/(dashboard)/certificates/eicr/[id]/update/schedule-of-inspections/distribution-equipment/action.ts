...
export async function updateContractorClientAndInstallation(electricalInstallationConditionReport: z.infer<typeof UpdateDistributionEquipmentSchema>): Promise<ServerActionResponse<void>> {
  try {
