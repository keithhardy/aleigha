export const inspectionItems = [
  ...
  },
  {
    ...
    item: "4.12",
    label:
      "Confirmation that integral test button / switch causes RCD(s) to trip when operated (functional check) (643.10)",
  },
  {
    id: "item_4_13",
    item: "4.13",
    label:
      "RCD(s) provided for fault protection - includes RCBOs (411.4.204; 411.4.5; 411.5.2; 531.2)",
  },
  {
    id: "item_4_14",
    item: "4.14",
    label:
      "RCD(s) provided for additional protection / requirements, where required - includes RCBOs (411.3.3; 415.1)",
  },
  {
    id: "item_4_15",
    item: "4.15",
  ...
  },
  {
    ...
    item: "4.16",
    label:
      "Confirmation that integral test button / switch, where present, causes AFDD to trip when operated (643.10)",
  },
  {
    id: "item_4_17",
    item: "4.17",
