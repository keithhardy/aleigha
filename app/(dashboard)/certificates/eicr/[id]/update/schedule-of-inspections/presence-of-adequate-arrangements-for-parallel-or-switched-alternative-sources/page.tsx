...
export default async function UpdatePresenceOfAdequateArrangements({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <UpdatePresenceOfAdequateArrangementsForm electricalInstallationConditionReport={electricalInstallationConditionReport as ElectricalInstallationConditionReport} />;
}
