...
export default async function UpdateScheduleOfItemsInspected({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <UpdateMethodsOfProtectionForm electricalInstallationConditionReport={electricalInstallationConditionReport as ElectricalInstallationConditionReport} />;
}
