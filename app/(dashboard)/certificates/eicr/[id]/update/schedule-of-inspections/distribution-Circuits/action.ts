...
export async function updateDistributionCircuits(electricalInstallationConditionReport: z.infer<typeof UpdateDistributionCircuitsSchema>): Promise<ServerActionResponse<void>> {
  try {
