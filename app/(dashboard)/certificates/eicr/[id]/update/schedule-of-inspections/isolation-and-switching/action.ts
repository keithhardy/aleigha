...
export async function updateIsolationAndSwitching(electricalInstallationConditionReport: z.infer<typeof UpdateIsolationAndSwitchingSchema>): Promise<ServerActionResponse<void>> {
  try {
