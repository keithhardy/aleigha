...
export async function updateFinalCircuits(electricalInstallationConditionReport: z.infer<typeof UpdateFinalCircuitsSchema>): Promise<ServerActionResponse<void>> {
  try {
