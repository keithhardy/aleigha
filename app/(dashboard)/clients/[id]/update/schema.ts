...
export const UpdateClientSchema = z.object({
  ...
  phone: z.string().regex(/^[\d\s+()-]+$/, "Phone number can only contain digits, spaces, +, (), and -"),
  picture: z
  ...
  address: z.object({
    id: z.string().cuid(),
    streetAddress: z.preprocess((val) => (val === "" ? undefined : val), z.string().min(3, "Street address must be at least 3 characters").optional()),
    city: z.preprocess((val) => (val === "" ? undefined : val), z.string().min(2, "City must be at least 2 characters").optional()),
    ...
    country: z.preprocess((val) => (val === "" ? undefined : val), z.string().min(2, "Country must be at least 2 characters").optional()),
  }),
});
