...
export function UpdatePictureForm({ settings }: { settings: (Settings & { address: Address | null }) | null }) {
  ...
  const [picturePreviewUrl, setPicturePreviewUrl] = useState<string | null>(settings?.picture || null);
        ...
        <Card className="rounded-md shadow-none">
          <div className="flex flex-col gap-4 p-6 lg:flex-row">
            <CardHeader className="w-full p-0">
              ...
              <CardDescription className="text-primary">Add your organization’s logo.</CardDescription>
            </CardHeader>
